        ...
        <div className="flex-1 flex flex-col items-center justify-center px-6 md:px-12 py-8 md:py-12 relative">
            <div className="max-w-[1600px] w-full flex items-center justify-between gap-8 md:gap-12">
                ...
                <div className="flex flex-col max-w-2xl space-y-6">
                    ...
                    <Button className="bg-primary text-primary-foreground hover:bg-primary/90 text-base sm:text-lg px-6 sm:px-8 py-4 sm:py-4 rounded-xl w-fit transition-all duration-300">
                        Start a project
                    </Button>
                </div>
